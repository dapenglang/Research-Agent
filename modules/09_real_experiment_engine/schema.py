...
Defines the structure of input and output files for Module 09,
...
INPUT_FILE_SCHEMAS: Dict[str, Dict[str, Any]] = {
    ...
    "experiment_matrix.yaml": {
        ...
        "experiments[].data_origin": {"type": "str", "required": True, "must_be": 'real'},
...
OUTPUT_FILE_SCHEMAS: Dict[str, Dict[str, Any]] = {
    "experiments/<task_id>/config/": {
        "fields": {
        "experiment_config.json": {"type": "Dict", "required": True},
        "hyperparameters.json": {"type": "Dict", "required": True},
        }
    },
    "experiments/<task_id>/raw_results/": {
        "fields": {
        "results.json": {"type": "Dict", "required": True},
        "data_origin": {"type": "str", "required": True, "must_be": 'real'},
        }
    },
    "experiments/<task_id>/processed_results/": {
        "fields": {
        "metrics.json": {"type": "Dict[str, float]", "required": True},
        "data_origin": {"type": "str", "required": True, "must_be": 'real'},
        }
    },
    "experiments/<task_id>/provenance/": {
        "fields": {
        "execution_log.json": {"type": "Dict", "required": True},
        "adapter_used": {"type": "str", "required": True},
        "adapter_version": {"type": "str", "required": True},
        "data_origin": {"type": "str", "required": True, "must_be": 'real'},
        "environment": {"type": "Dict[str, str]", "required": True},
        "git_commit": {"type": "str", "required": False},
        }
    },
    "experiments/<task_id>/environment/": {
        "fields": {
        "requirements.txt": {"type": "str", "required": True},
        "python_version": {"type": "str", "required": True},
        "os_info": {"type": "Dict[str, str]", "required": True},
        }
    },
}
