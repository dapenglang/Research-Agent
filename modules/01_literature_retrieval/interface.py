...
that any implementation of Module 01 must satisfy.
...
@dataclass
class LiteratureRetrievalInput:
    """Standard input for Module 01 — Literature Retrieval.
    ...
    # No upstream modules (entry point)


@dataclass
class LiteratureRetrievalOutput:
    """Standard output for Module 01 — Literature Retrieval.
...
class Module01Interface(ABC):
    """Interface contract for Module 01 — Literature Retrieval.

    Upstream:   none (entry point)
    Downstream: 02, 03

    This interface defines the lifecycle of Module 01:
