...
that any implementation of Module 08 must satisfy.
...
class SyntheticExperimentInput:
    """Standard input for Module 08 — Synthetic Experiment Engine.
...
@dataclass
class SyntheticExperimentOutput:
    """Standard output for Module 08 — Synthetic Experiment Engine.

    Output files produced:
    - synthetic_results/raw/
    - synthetic_results/processed/
    - synthetic_results/metrics.csv
    - synthetic_results/statistics.json
    - synthetic_results/figures/
    - synthetic_results/tables/
    - synthetic_results/analysis/
...
# NOTE: SAMRA Monte Carlo is a backend adapter, NOT built into this module.


class Module08Interface(ABC):
    """Interface contract for Module 08 — Synthetic Experiment Engine.

    Upstream:   06, 07
    Downstream: 10, 11

    This interface defines the lifecycle of Module 08:
