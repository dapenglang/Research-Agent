...
that any implementation of Module 04 must satisfy.
...
@dataclass
class ResearchLandscapeInput:
    """Standard input for Module 04 — Research Landscape & Gap Analysis.
...
@dataclass
class ResearchLandscapeOutput:
    """Standard output for Module 04 — Research Landscape & Gap Analysis.
...
class Module04Interface(ABC):
    """Interface contract for Module 04 — Research Landscape & Gap Analysis.

    Upstream:   03
    Downstream: 05

    This interface defines the lifecycle of Module 04:
    ...
    @abstractmethod
    def execute(self, input_data: ResearchLandscapeInput) -> ResearchLandscapeOutput:
    ...
    @abstractmethod
    def quality_assessment(self, output: ResearchLandscapeOutput) -> Dict[str, Any]:
    ...
    @abstractmethod
    def write_manifest(self, output: ResearchLandscapeOutput) -> Dict[str, Any]:
