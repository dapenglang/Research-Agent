...
Defines the structure of input and output files for Module 12,
...
INPUT_FILE_SCHEMAS: Dict[str, Dict[str, Any]] = {
    "figures/": {
        "fields": {
        "svg_files": {"type": "List[str]", "required": True},
        "pdf_files": {"type": "List[str]", "required": True},
        "captions.yaml": {"type": "file", "required": True},
        }
    },
    "tables/": {
        "fields": {
        "xlsx_files": {"type": "List[str]", "required": False},
        "csv_files": {"type": "List[str]", "required": False},
        "tex_files": {"type": "List[str]", "required": False},
        }
    },
    "paper_style_profile.json": {
        "fields": {
        "venue": {"type": "str", "required": False},
        "style": {"type": "str", "required": False, "default": 'ieee'},
        "page_limit": {"type": "int", "required": False},
        "citation_style": {"type": "str", "required": False, "default": 'numeric'},
        }
    },
}
...
OUTPUT_FILE_SCHEMAS: Dict[str, Dict[str, Any]] = {
    "paper/paper.md": {
        ...
        "sections[].heading": {"type": "str", "required": True},
        "sections[].content": {"type": "str", "required": True},
        "figure_references": {"type": "List[str]", "required": True},
        "table_references": {"type": "List[str]", "required": True},
        }
    },
    "paper/latex/": {
        "fields": {
        "main.tex": {"type": "file", "required": True},
        "references.bib": {"type": "file", "required": False},
        "figures/": {"type": "dir", "required": True},
        "Makefile": {"type": "file", "required": False},
        }
    },
    "paper/word/": {
        "fields": {
        "paper.docx": {"type": "file", "required": True},
        "embedded_figures": {"type": "List[str]", "required": True},
        }
    },
}
