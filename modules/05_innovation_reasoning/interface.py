...
that any implementation of Module 05 must satisfy.
...
@dataclass
class InnovationReasoningInput:
    """Standard input for Module 05 — Innovation & Novelty Reasoning.
    ...
    upstream_module_03: Dict[str, Any]  # outputs from Module 03
    upstream_module_04: Dict[str, Any]  # outputs from Module 04


@dataclass
class InnovationReasoningOutput:
    """Standard output for Module 05 — Innovation & Novelty Reasoning.
...
class Module05Interface(ABC):
    """Interface contract for Module 05 — Innovation & Novelty Reasoning.

    Upstream:   03, 04
    Downstream: 06

    This interface defines the lifecycle of Module 05:
    ...
    @abstractmethod
    def execute(self, input_data: InnovationReasoningInput) -> InnovationReasoningOutput:
    ...
    @abstractmethod
    def quality_assessment(self, output: InnovationReasoningOutput) -> Dict[str, Any]:
    ...
    @abstractmethod
    def write_manifest(self, output: InnovationReasoningOutput) -> Dict[str, Any]:
