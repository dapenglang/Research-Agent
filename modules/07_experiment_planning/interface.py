...
that any implementation of Module 07 must satisfy.

Upstream: 06
Downstream: 08, 09, 10, 11
"""
...
@dataclass
class ExperimentPlanningInput:
    """Standard input for Module 07 — Experiment Planning.
...
@dataclass
class ExperimentPlanningOutput:
    """Standard output for Module 07 — Experiment Planning.
...
class Module07Interface(ABC):
    """Interface contract for Module 07 — Experiment Planning.

    Upstream:   06
    Downstream: 08, 09, 10, 11

    This interface defines the lifecycle of Module 07:
    ...
    @abstractmethod
    def execute(self, input_data: ExperimentPlanningInput) -> ExperimentPlanningOutput:
    ...
    @abstractmethod
    def quality_assessment(self, output: ExperimentPlanningOutput) -> Dict[str, Any]:
    ...
    @abstractmethod
    def write_manifest(self, output: ExperimentPlanningOutput) -> Dict[str, Any]:
