...
Defines the structure of input and output files for Module 11,
...
OUTPUT_FILE_SCHEMAS: Dict[str, Dict[str, Any]] = {
    "figures/*.svg": {
        "fields": {
        "figure_id": {"type": "str", "required": True},
        "data_origin": {"type": "str", "required": True, "allowed": ['synthetic', 'real', 'external']},
        "vector_format": {"type": "bool", "required": True, "must_be": True},
        }
    },
    "figures/source_data/": {
        "fields": {
        "data_files": {"type": "List[str]", "required": True},
        "data_origin": {"type": "str", "required": True},
        }
    },
    "figures/plotting_specs/": {
        "fields": {
        "spec_files": {"type": "List[str]", "required": True},
        "spec_format": {"type": "str", "required": True},
        }
    },
    "tables/*.xlsx": {
        "fields": {
        "table_id": {"type": "str", "required": True},
        "data_origin": {"type": "str", "required": True, "allowed": ['synthetic', 'real', 'external']},
        }
    },
    "captions/captions.yaml": {
        "fields": {
        "captions": {"type": "List[Dict]", "required": True},
        "captions[].id": {"type": "str", "required": True},
        "captions[].caption": {"type": "str", "required": True},
        "captions[].type": {"type": "str", "required": True, "allowed": ['figure', 'table']},
        }
    },
}
